...
async def run_research_agent(topic: str = None) -> str:
    ...
    MODEL = os.environ.get("RESEARCHER_MODEL", "bedrock/us.amazon.nova-pro-v1:0")
...
async def health():
    ...
    return {
        ...
        "bedrock_model": os.environ.get("RESEARCHER_MODEL", "bedrock/us.amazon.nova-pro-v1:0"),
    }
...
# Lambda handler — Mangum adapts ASGI (FastAPI) to Lambda events
