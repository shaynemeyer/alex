...
def test_multiple_accounts():
    ...
    positions1 = [("SPY", 100), ("QQQ", 50), ("BND", 200)]
    ...
    positions2 = [("VTI", 75), ("VXUS", 50), ("GLD", 25)]
    ...
    positions3 = [("VEA", 150), ("TSLA", 10), ("ARKK", 50), ("BND", 300)]
    ...
    if success:
        ...
        if job_status.get("report_payload"):
            ...
            print(
                f'  All accounts analyzed: {"✅ YES" if accounts_mentioned else "❌ NO"}'
            )
        ...
        if job_status.get("charts_payload"):
            ...
            print(
                f'  Account distribution chart: {"✅ YES" if has_account_chart else "❌ NO"}'
            )
